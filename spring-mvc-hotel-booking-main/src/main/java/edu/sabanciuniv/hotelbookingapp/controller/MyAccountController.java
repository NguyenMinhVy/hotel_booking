...
public class MyAccountController {
    ...
    public String editCustomerAccount(@Valid @ModelAttribute("users") UserDTO userDTO, BindingResult result) {
    ...
    public String editHotelManagerAccount(@Valid @ModelAttribute("users") UserDTO userDTO, BindingResult result) {
